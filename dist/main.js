...
/*$vite$:1*/`),
          ...
          d !== void 0 &&
            ...
            (W(i[a]) && W(s[a])
              ? s[a].__swiper__
                ...
                : V(i[a], s[a])
              : !W(i[a]) && W(s[a])
              ? ((i[a] = {}), s[a].__swiper__ ? (i[a] = s[a]) : V(i[a], s[a]))
              : (i[a] = s[a]));
        }
      }
    }
  ...
  function Ze() {
    ...
    d &&
      (o ||
        ((c = Ve(d, `.${t.slideClass}, swiper-slide`)[0]),
        t.loop && !c && (c = e[0]),
  ...
  var Vt = { attachEvents: Gt, detachEvents: Dt };
  ...
  function $t() {
    ...
    const b = u.direction && u.direction !== s.direction,
      ...
      f = s.loop;
    b && t && i.changeDirection(), V(i.params, u);
  ...
  var Nt = { setBreakpoint: $t, getBreakpoint: Ft };
  function Yt(i, e) {
    const t = [];
    return (
      i.forEach((s) => {
  ...
  const pe = function (i, e, t = 600, s, n, r = null, o = 1, a = 2, d = 3) {
    const l = i.closest(
        "[data-grid-swiper], [data-features-swiper], [data-restaurant-swiper]"
      ),
      c = l ? l.querySelector("[data-swiper-nav]") : null,
      u = c ? c.querySelector("[data-swiper-prev]") : null,
      g = c ? c.querySelector("[data-swiper-next]") : null,
      h = {
        modules: [Xt, Qt, ei],
        direction: "horizontal",
        speed: t,
        ...
        spaceBetween: n,
        breakpoints: {
          320: { slidesPerView: o, spaceBetween: 16 },
          480: { slidesPerView: o, spaceBetween: 16 },
          768: { slidesPerView: a, spaceBetween: 20 },
          992: { slidesPerView: d, spaceBetween: n },
          1200: { slidesPerView: s, spaceBetween: n },
        },
      };
    r && (h.effect = r), u && g && (h.navigation = { nextEl: g, prevEl: u });
    try {
      return new $(i, h);
    } catch {
      return null;
  ...
  function ti(i = 1, e = 1, t = 1) {
    const s = document.querySelector("[data-grid-swiper]");
    if (s) {
      const n = s.querySelector(".swiper");
      n && pe(n, !0, 600, 1, 24, null, i, e, t);
    }
  }
  function ii(i = 1.25, e = 2, t = 2) {
    document.querySelectorAll("[data-features-swiper]").forEach((n, r) => {
      const o = n.querySelector(".swiper");
      o && pe(o, !1, 600, 3, 16, null, i, e, t);
    });
  }
  function si(i = !0, e = 300, t = 1, s = 0, n = null, r = 1, o = 1, a = 1) {
    const d = document.querySelector("[data-restaurant-swiper]");
    if (d) {
      const l = d.querySelector(".swiper");
      l && pe(l, !1, e, t, s, "cards", r, o, a);
    }
  }
  function ri() {
    ti(), ii(), si();
